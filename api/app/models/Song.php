...
class Song extends Base\BCFModel
{
    ...
    public function initialize()
    {
        ...
        $this->setSource("song");
        $this->hasMany('songId', 'BCF\Models\SongLanguage', 'songId', ['alias' => 'SongLanguages']);
        $this->hasMany('songId', 'BCF\Models\SongSongStructure', 'songId', ['alias' => 'SongSongStructures']);
    ...
    {
        return [
            'songLanguages' => $this->getSongLanguages(),
            'songSongStructures' => $this->getSongSongStructures(),
        ];
    }
    ...
    public function getWriters()
    {
        if (empty($this->writers)) {
            ...
            foreach ($this->getSongLanguages() as $songLanguage) {
                if (!empty($songLanguage->getWriter())) {
                    $this->writers[] = $songLanguage->getWriter();
                }
            }
        }
